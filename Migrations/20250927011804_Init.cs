    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, 1, "Lima", "DEP001", "Av. Principal 123", 2, "dep1.jpg", 70, 150000.0, "Departamento", "Departamento céntrico" },
                    { 2, true, 2, "Arequipa", "CAS001", "Calle Flores 456", 3, "casa1.jpg", 120, 250000.0, "Casa", "Casa familiar" },
                    { 3, true, 1, "Lima", "OFI001", "Av. Negocios 789", 0, "ofi1.jpg", 50, 100000.0, "Oficina", "Oficina moderna" }
                });
